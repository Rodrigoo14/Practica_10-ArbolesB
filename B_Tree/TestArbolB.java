...
public class TestArbolB {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		//EJERCICIO 1
		System.out.println("\nEliminamos la clave 30");
		arbolB.eliminarClave(30);
		System.out.println("");
		System.out.println("ESTADO ARBOL B");
		arbolB.showBTree();
		System.out.println("");
		System.out.println("\nEliminamos la clave 60");
		arbolB.eliminarClave(60);
		System.out.println("");
		System.out.println("ESTADO ARBOL B");
		arbolB.showBTree();
		System.out.println("");
		...
		//EJERCICIO 2
		System.out.println("\nBuscando el camino al nodo 90:");
		System.out.println(arbolB.obtenerCaminoRecorridoHastaNodo(90));
		System.out.println("");
		
		//EJERCICIO 3
		System.out.println("\nTodas las claves del nodo 80:");
		System.out.println(arbolB.buscarClavesNodo(80));
		System.out.println("");
		
		
		//EJERCICIO 4
		System.out.println("\nValor maximo del arbol:");
		System.out.println(arbolB.obtenerValorMaximo());
		System.out.println("");
		
		//EJERCICIO 5
		System.out.println("\nNodo minimo de la raiz:");
		arbolB.obtenerNodoMinimo();
		System.out.println("");
